...
import {
  ...
  useNicknameTransferQuery,
  useTransferValidateMutation,
} from "@/queries/transfer.query";
...
const TransferPage = () => {
  ...
  const toAccountId = useSelector(
    (state: RootState) => state.transfer.toAccountId
  );
      ...
      <form className="w-full bg-white p-8">
        ...
        <div className="mb-4">
          ...
          <Select value={selectedNicknameValue} onValueChange={handleSelect}>
            <SelectTrigger className="w-full">
              <SelectValue
                placeholder={
                  isLoadingAccountInfo ? "Loading..." : "Select a nickname"
                }
              />
            </SelectTrigger>
            <SelectContent>
        ...
        <div className="mb-6">
          ...
          <Input
            ...
            value={fullname}
            readOnly
            placeholder={isLoadingAccountInfo ? "Loading..." : "Full name"}
            disabled={isLoadingAccountInfo}
          />
        </div>
