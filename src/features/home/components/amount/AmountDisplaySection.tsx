...
function AmountDisplaySection() {
  ...
  return (
    <section className="w-full h-full max-h-60 bg-white flex flex-col justify-center items-center rounded-lg p-5">
      <h1 className="text-center md:text-start w-full text-xl md:text-4xl font-semibold mb-3">
        E-Wallet Balance (MMK)
      </h1>
      <p className="flex space-x-2 w-full h-12 justify-center md:justify-start items-center">
        <span className="cursor-default text-xl md:text-2xl select-none font-semibold">
